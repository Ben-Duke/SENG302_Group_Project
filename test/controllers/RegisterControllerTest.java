...
public class RegisterControllerTest extends WithApplication {
    ...
    public void isEmailValidEmptyString() {
        assertFalse(this.registerController.isEmailValid(""));
    }

    @Test
    public void isEmailValidNoAtSymbol() {
        assertFalse(this.registerController.isEmailValid("test"));
    }
    ...
    public void isEmailValidWithTooManyDomainPeriodsInARowAfter() {
        assertFalse(this.registerController.isEmailValid("test@test.."));
    }
    ...
    public void isEmailValidNoUsername() {
        assertFalse(this.registerController.isEmailValid("@test.com"));
    }
    ...
    public void isEmailValidWithMultiplePeriodsInARowInUsername() {
        assertFalse(this.registerController.isEmailValid("test..@test.com"));
    }
    ...
    public void isEmailValidWithUniEmail() {
        assertTrue(this.registerController.isEmailValid("lsh73@uclive.ac.nz"));
    }

    @Test
    public void isEmailValidSecondLevelDomain() {
        assertTrue(this.registerController.isEmailValid("test@test.test"));
    }

    @Test
    public void isEmailValidUsernameShort() {
        assertTrue(this.registerController.isEmailValid("t@test.test"));
    }

    @Test
    public void isEmailValidLong() {
        assertTrue(this.registerController.isEmailValid("ilushmleviruasjkdoaasdasdasdasdasdasdasdasdasdasdasdasd" +
                "asddasdadkjahmikueijawasdasdasdjadiaksjdiajsduahduadjyagsduyah@test.test"));
    }

    @Test
    public void isEmailValidPeriodInUsername() {
        assertTrue(this.registerController.isEmailValid("te.st@test.test"));
    }
