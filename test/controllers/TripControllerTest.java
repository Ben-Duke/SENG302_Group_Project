...
public class TripControllerTest extends WithApplication {
    ...
    public void setupDatabase() {
        ...
        TripFormData tripForm = new TripFormData("testTrip");
        long tripid = tripfactory.createTrip(tripForm, user);
    ...
    public void savetrip() {
        ...
        Http.RequestBuilder request = Helpers.fakeRequest().bodyForm(formData).method(Helpers.POST).uri("/users/trips/create").session("connected", "1");
        ...
        //"Newly created Trip with name "triptest123" should be the second index in the database
        assertEquals("triptest123", User.find.byId(1).getTrips().get(1).getTripName());
    }
    */
